...
public class FindCourseTest {
    private FindCourseActivity activity;
    ...
    public void setup() {
        ...
        Intent intent = new Intent(appContext,FindCourseActivity.class);
        intent.putParcelableArrayListExtra("discMaps",discMaps);
        FirebaseApp.initializeApp(appContext);
        activity = Robolectric.buildActivity(FindCourseActivity.class,intent)
                .create()
                .start()
                .resume()
                .visible()
